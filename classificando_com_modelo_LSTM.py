...
prever_noticia(true_news_política[0])

prever_noticia(true_news_política[1])

prever_noticia(true_news_política[2])

prever_noticia(true_news_política[3])
prever_noticia(true_news_política[4])